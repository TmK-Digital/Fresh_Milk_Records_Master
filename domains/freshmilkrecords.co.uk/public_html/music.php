    ...
    <header>
        ...
        <div class="container">
            <nav class="nav">
                ...
                <a href="index.php" class="logo"><img src="images/logo-nav.png" alt=""></a>
      <ul class="nav-list">
            ...
            <div class="grid-item">
                ...
                <div class="grid-item-wrapper">
                    <div class="card">
                        ...
                        <h3>Dee Cypher</h3>
                        <h3>Back to your love EP £11.99</h3>
...
<tr><td><input type="hidden" name="on0" value="FM-001"></td></tr><tr><td><select name="os0">
	<option value="UK + Shipping">UK + Shipping £15.99 GBP</option>
	<option value="Europe + Shipping">Europe + Shipping £19.99 GBP</option>
	<option value="Worldwide + Shipping">Worldwide + Shipping £31.99 GBP</option>
</select> </td></tr>
</table>
            ...
            <div class="grid-item">
                ...
                <div class="grid-item-wrapper">
                    <div class="card">
                        ...
                        <h3 style="color:black;">Full Circle EP £11.99</h3>
...
<tr><td><input type="hidden" name="on0" value="FM-002 with Shipping"></td></tr><tr><td><select name="os0">
	<option value="UK + Shipping">UK + Shipping £15.99 GBP</option>
	<option value="EU + Shipping">EU + Shipping £19.99 GBP</option>
	<option value="Worldwide + Shipping">Worldwide + Shipping £31.99 GBP</option>
</select> </td></tr>
</table>
                            <input type="hidden" name="currency_code" value="GBP">
                            <br>
                            <input type="image" src="images/addtocart.jpg" style="width: 99px;" border="0" name="submit" alt="PayPal – The safer, easier way to pay online!">
                            <img alt="" border="0" src="https://www.paypalobjects.com/en_GB/i/scr/pixel.gif" width="1" height="1">
                                     <p style="padding-bottom:20px;"> release: 20/06/2020</p>
                        </form>
            ...
            <div class="grid-item">
                ...
                <div class="grid-item-wrapper">
                    <div class="card">
                        <img src="images/ray.png" style=" padding-left:10px;max-width: 100%; height:250px; padding-left:20px; padding-right:20px">
                        <h3 style="color:black;">Ray Hurley </h3>
                        <h3 style="color:black;">Digging the Crates Vol.1</h3>
                           <h4 style="color:black;">£13.99</h2>
     

 <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="Z4PQMYHVCB8GC">
<table >
           <td style="padding-left: 40px; padding-right: 30px;"><select name="os0">
                                <option value="UK - Shipping">UK - Shipping £18.49 GBP</option>
                                <option value="Europe - Shipping">Europe - Shipping £26.99 GBP</option>
                                <option value="Worldwide - Shipping">Worldwide - Shipping £35.99 GBP</option>
                            </select> </td>
                                </tr>
                            </table>
                            <input type="hidden" name="currency_code" value="GBP">
                            ...
                            <img alt="" border="0" src="https://www.paypalobjects.com/en_GB/i/scr/pixel.gif" width="1" height="1">
                                     <p style="padding-bottom:20px;"> release: 14/09/2020</p>
                        </form>
