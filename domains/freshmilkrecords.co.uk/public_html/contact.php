...
else
{
 // Get login url
    ...
    $facebook_login_url = $facebook_helper->getLoginUrl('http://localhost/fmdraft/user-index.php', $facebook_permissions);
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v7.0&appId=2954324477977774&autoLogAppEvents=1"></script>
  ...
  <form id="contact" 
    ...
    <fieldset style="diplay:flex" >
          <a href="mailto:freshmilkrecords@mail.com"> <img src="images/email-icon.png"  style="width:60px"  a href="mailto:freshmilkrecords@mail.com">
<br>
<br>
<a href="mailto:freshmilkrecords@mail.com" style="color:black;font-size:18px;"> Email Us</a>
<br>
<br>
			<a class="facebookBtn smGlobalBtn" href="https://www.facebook.com/freshmilkrecords"></a>
			<br>
			<br>
		<h2 style="font-size-18px;">Follow us</h2>
