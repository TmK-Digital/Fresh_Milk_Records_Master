    ...
    <div class="product-container">
        ...
        <div class="grid-row">
                            ...
                            <table>
                                <tr>
                                    <td><input type="hidden" name="on0" value="Fresh Milk Slipmats + Postage">
                                        <h3 style=" text-decoration: underline;"> DJ Slipmats £15</h3>
                                    </td>
                                    <br>
                                </tr>
                            ...
                            <table>
                                <tr>
                                    <td><input type="hidden" name="on0" value="Fresh Milk Box Logo T-shirt  + Postage">
                                        <h3 style="text-decoration:underline;margin-bottom: 13px;">Logo Tee £15 </td>
                                    </h3>
                                </tr>
                                <tr>
            ...
            <div class="grid-item">
                ...
                <div class="grid-item-wrapper">
                    <div class="card">
                        <img src="images/crate-shirt.jpg" style="width:100%">
                            ...
                            <table>
                                <tr>
                                    <td><input type="hidden" name="on0" value="Fresh Milk Crate Logo T-shirt  + Postage">
                                        <h3 style="text-decoration:underline;margin-bottom: 13px;">  Crate Tee £15</td>
                                </tr>
                                <tr>
                                    <td style="padding-left: 40px; padding-right: 30px;"><select name="os0">
                                <option value="UK - Shipping">UK - Shipping £19 GBP</option>
...
<table>
      <tr>
                                    <td><input type="hidden" name="on0" value="">
                                        <h3 style="text-decoration:underline;margin-bottom: 13px;"> Black  Crate Tee £15 </td>
                                </tr>
                                <tr>
                                    <td style="padding-left: 40px; padding-right: 30px;"><select name="os0">
                                <option value="UK - Shipping">UK - Shipping £19 GBP</option>
