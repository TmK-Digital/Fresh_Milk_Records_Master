function validateContactForm() {
    ...
    $(".captcha-container").css('border', '#e0dfdf 1px solid');

    var userName = $("#userName").val();
    var userEmail = $("#userEmail").val();
    var subject = $("#subject").val();
    var content = $("#content").val();
    var captcha = $("#captcha-chosen").val();
    ...
    if (captcha == "") {
        ...
        $(".captcha-container").css('border', '#e66262 1px solid');
...
$(".svg-padding").on('click', function() {
    $(".svg").removeClass('captcha-selected');
    $(this).find(".svg").addClass('captcha-selected');
    var icons = $(this).find(".icons").val();
    $("#captcha-chosen").val(icons);
});